...
local ConvarClass = {}
ConvarClass.HookLabel = "TTT2CursedDeagleHookLabel"
ConvarClass.UlxLabel = "TTT2CursedDeagleUlxLabel"
...
--Cursed Deagle ConVars
local cursed_deagle_cfg = ConvarGroup("Cursed Deagle", "Cursed Deagle for TTT2")
Convar(cursed_deagle_cfg, false, "ttt2_cursed_deagle_refill_time", "30", {FCVAR_SERVER_CAN_EXECUTE, FCVAR_NOTIFY, FCVAR_ARCHIVE}, "How many seconds should it take for the Cursed Deagle to refill if it fails (<=0 to not refill at all)?", "int", 0, 120, 0)
Convar(cursed_deagle_cfg, false, "ttt2_cursed_deagle_affect_det", "0", {FCVAR_SERVER_CAN_EXECUTE, FCVAR_NOTIFY, FCVAR_ARCHIVE}, "Can the Cursed Deagle be used on Detectives?", "bool", 0, 1, 0)
